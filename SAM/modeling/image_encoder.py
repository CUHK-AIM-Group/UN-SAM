...
from .common import LayerNorm2d, MLPBlock, DomainCommon, DomainSpecific
...
def add_decomposed_rel_pos(
    ...
    rel_k = rel_h[:, :, :, :, None] + rel_w[:, :, :, None, :]
    rel_k = rel_k.view(rel_k.shape[0], rel_k.shape[1], rel_k.shape[2], -1)
